...
//     const Adjust: {
//         initSdk: (config: { appToken: string; environment: Environment }) => void;

//         addGlobalCallbackParameters: () => void;
//         addGlobalPartnerParameters: () => void;
//         removeGlobalCallbackParameter: () => void;
